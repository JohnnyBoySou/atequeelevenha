    ...
    return (
        <Main style={{ alignItems: 'center',  }}>
                ...
                <MotiView from={{opacity: 0, transformY: 40,}} animate={{opacity: 1, transformY: 0}} transition={{delay: 100, duration: 300,}}>
                  <Column style={{ marginHorizontal: 20, justifyContent: 'center',  borderRadius: 24, paddingHorizontal: 24, marginTop: 50,}}>
                  <Image source={require('@assets/imgs/logo_3.png')} style={{ width: 140, height: 130, marginBottom: 24, alignSelf: 'center',}} />
                  <Title style={{ fontSize: 62, color: "#142B74", fontFamily: font.bold, lineHeight: 56}}>Bem-vindo, {'\n'}Entre para Continuar</Title>
